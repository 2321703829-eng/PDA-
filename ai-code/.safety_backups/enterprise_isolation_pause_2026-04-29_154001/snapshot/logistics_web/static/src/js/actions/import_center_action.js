...
export class LogisticsImportCenterAction extends Component {
    ...
    setup() {
        ...
        this.imagePackageFileInputRef = useRef("imagePackageFileInput");
        this.display = {
            controlPanel: false,
            searchPanel: false,
        };
    ...
    get ui() {
        return {
            ...
            sectionImagePackageTitle: "\u56fe\u7247\u5305\u5bfc\u5165",
            sectionImagePackageHint: "\u4e0a\u4f20 ZIP \u56fe\u7247\u5305\u540e\uff0c\u7cfb\u7edf\u4f1a\u6309\u6587\u4ef6\u540d\u89c4\u5219\u547d\u4e2d\u8fd0\u5355\uff0c\u5e76\u8865\u94fe\u5230\u6b63\u5f0f\u7559\u75d5\u8bc1\u636e\u94fe\u3002",
            imagePackageChooseFile: "\u9009\u62e9\u56fe\u7247\u5305",
            imagePackageReplaceFile: "\u91cd\u65b0\u9009\u62e9\u56fe\u7247\u5305",
            imagePackageUpload: "\u5f00\u59cb\u5bfc\u5165\u56fe\u7247\u5305",
            imagePackageUploading: "\u5bfc\u5165\u4e2d...",
            imagePackageViewTasks: "\u67e5\u770b\u56fe\u7247\u5305\u4efb\u52a1",
            imagePackageViewCurrentTask: "\u6253\u5f00\u672c\u6b21\u56fe\u7247\u5305\u4efb\u52a1",
            imagePackageUploadSuccess: "\u56fe\u7247\u5305\u5bfc\u5165\u5df2\u5b8c\u6210\uff0c\u6b63\u5728\u6253\u5f00\u4efb\u52a1\u8be6\u60c5\u3002",
            imagePackageUploadFailed: "\u56fe\u7247\u5305\u5bfc\u5165\u5931\u8d25\uff0c\u8bf7\u5148\u6838\u5bf9 ZIP \u5185\u6587\u4ef6\u540d\u4e0e\u5185\u5bb9\u3002",
            imagePackageResultTitle: "\u56fe\u7247\u5305\u5bfc\u5165\u7ed3\u679c",
            imagePackageResultHint: "\u5173\u6ce8\u547d\u4e2d\u3001\u8865\u94fe\u4e0e\u4eba\u5de5\u590d\u6838\u60c5\u51b5\uff0c\u5931\u8d25\u8bb0\u5f55\u53ef\u4ece\u4efb\u52a1\u5355\u91cc\u91cd\u8bd5\u3002",
            imagePackageMatchedLabel: "\u5df2\u547d\u4e2d",
            imagePackageUnmatchedLabel: "\u672a\u547d\u4e2d",
            imagePackageLinkedLabel: "\u5df2\u8865\u94fe",
            imagePackageManualReviewLabel: "\u5f85\u4eba\u5de5\u590d\u6838",
            imagePackageTaskStatusLabel: "\u4efb\u52a1\u72b6\u6001",
    ...
    get imagePackageFileLabel() {
        return this.state.imagePackageSelectedFile?.name || this.ui.noFile;
    }
    ...
    get hasImagePackageSelectedFile() {
        return Boolean(this.state.imagePackageSelectedFile);
    }
    ...
    get hasImagePackageImportResult() {
        return Boolean(this.state.imagePackageImportResult);
    }
    ...
    triggerImagePackageFileSelect() {
        if (this.imagePackageFileInputRef.el) {
            this.imagePackageFileInputRef.el.value = "";
        }
        this.imagePackageFileInputRef.el?.click();
    }

    onImagePackageFileChanged(ev) {
        const file = ev.target.files?.[0];
        this.state.imagePackageSelectedFile = file || null;
        this.state.imagePackageImportResult = null;
        this.state.error = "";
    }
    ...
    async uploadImagePackage() {
        if (!this.state.imagePackageSelectedFile) {
            this.state.error = this.ui.noFile;
            return;
        }
        this.state.imagePackageUploading = true;
        this.state.error = "";
        this.state.imagePackageImportResult = null;
        try {
            const formData = new FormData();
            formData.append("file", this.state.imagePackageSelectedFile);
            const payload = await this.apiRequest("/api/admin/logistics/imports/image-package/upload", {
                method: "POST",
                body: formData,
            });
            this.state.imagePackageImportResult = payload.data;
            this.notification.add(this.ui.imagePackageUploadSuccess, { type: "success" });
            await this.openImagePackageTask(payload.data?.task_id);
        } catch (error) {
            this.state.error = this.mapLoadError(error, this.ui.imagePackageUploadFailed);
        } finally {
            this.state.imagePackageUploading = false;
        }
    }
    ...
    async openImagePackageTasks() {
        return this.actionService.doAction("logistics_trace_evidence.action_logistics_import_task_image_package");
    }

    async openImagePackageTask(taskId = this.state.imagePackageImportResult?.task_id) {
        if (!taskId) {
            return this.openImagePackageTasks();
        }

...
export class LogisticsDriverManagementActionV2 extends Component {
    ...
    get ui() {
        return {
            ...
            profileSubtitle: "围绕画像头部、核心指标、趋势与最近记录，快速判断司机当前执行状态。",
            badgePrimary: "司机画像",
            badgeSecondary: "执行资源",
            heroNoteTitle: "当前工作方向",
            heroNoteBodyList: "先统一司机筛选、风险标签和列表层级，再把画像页打磨成可复用的复杂页面样板。",
            heroNoteBodyProfile: "先看司机身份、车辆和活跃状态，再下钻 KPI、趋势与最近异常，快速完成风险判断。",
            searchPlaceholder: "按司机姓名、手机号或车辆搜索",
            searchButton: "搜索",
            resetButton: "重置",
            empty: "当前没有符合条件的司机，请调整筛选条件，或开启模拟模式查看演示数据。",
